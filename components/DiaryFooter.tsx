...
export default function DiaryFooter() {
  ...
  return (
    <footer className="relative pt-4 pb-12 overflow-hidden section-yellow">
      ...
      <div className="relative z-10 flex flex-col items-center pt-8">
        ...
        <motion.div
          ...
          transition={
            shouldReduceMotion
              ? undefined
              : { duration: 2.5, repeat: Infinity, ease: 'easeInOut', repeatDelay: 1 }
          }
        >
          <Image
        ...
        >
          ...
          <div className="mx-auto mt-3 mb-2" style={{ width: '150px', height: '2px' }}>
